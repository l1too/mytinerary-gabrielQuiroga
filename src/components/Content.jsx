...
const Content = () => {
  return (
<div className="card lg:card-side w-3/4 rounded-none mx-auto my-20 bg-slate-100 px-3">
    ...
    <figure className='w-3/4 max-[950px]:mx-auto '>
        <img src="/plane.jpg" alt="airplane"/>
    </figure>
</div>
  )
}
